...
export function Landing() {
  const cards = [
    { id: "candidate", path: "/candidate", iconBg: "linear-gradient(135deg,var(--primary),var(--primary-hover))", shadow: "rgba(99,102,241,.25)",
      icon: <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="var(--bg-card)" strokeWidth="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>,
      title: "Candidate Tools", desc: "CV summary, client email & candidate analysis" },
    { id: "jdhub", href: "https://jd-hub.netlify.app/", iconBg: "linear-gradient(135deg,var(--warning),var(--warning))", shadow: "rgba(245,158,11,.25)",
      icon: <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="var(--bg-card)" strokeWidth="2"><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/></svg>,
    ...
    { id: "jobpost", path: "/jobpost", iconBg: "linear-gradient(135deg,var(--success),var(--success-hover))", shadow: "rgba(16,185,129,.25)",
      icon: <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="var(--bg-card)" strokeWidth="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>,
    ...
    { id: "mail", path: "/mail", iconBg: "linear-gradient(135deg,var(--primary),var(--primary-hover))", shadow: "rgba(139,92,246,.25)",
      icon: <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="var(--bg-card)" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>,
    ...
    <main style={{ animation: "fadeIn .3s ease" }}>
      ...
      <div style={{ maxWidth: 840, margin: "0 auto", padding: "24px 16px 32px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(300px,1fr))", gap: 12 }}>
          {cards.map(c => {
            const s: any = { background: "var(--bg-card)", borderRadius: 14, border: "1.5px solid var(--border-color)", padding: "16px 18px", cursor: "pointer", transition: "all .18s", boxShadow: "0 1px 6px rgba(0,0,0,.04)", display: "flex", alignItems: "center", gap: 14, textDecoration: "none" };
            const hIn = (e: any) => { e.currentTarget.style.boxShadow = `0 8px 28px ${c.shadow}`; e.currentTarget.style.borderColor = "var(--border-indigo-200)"; e.currentTarget.style.transform = "translateY(-2px)"; };
            const hOut = (e: any) => { e.currentTarget.style.boxShadow = "0 1px 6px rgba(0,0,0,.04)"; e.currentTarget.style.borderColor = "var(--border-color)"; e.currentTarget.style.transform = ""; };
            const inner = (
              <>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <div style={{ fontSize: 12.5, color: "var(--text-placeholder)", lineHeight: 1.4, marginBottom: 7 }}>{c.desc}</div>
      ...
      {/* Time Buddy */}
      <div style={{ display: "flex", justifyContent: "center", marginTop: 12, paddingBottom: 32 }}>
        <Link to="/planner"
          style={{
